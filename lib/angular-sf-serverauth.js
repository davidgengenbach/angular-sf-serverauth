(function (_) {
  ...
  var module = angular.module('SFServerAuth', ['facebook']);
  module.module('SFServerAuth', ['facebook']).provider('ServerAuth', [function () {
        ...
        function ($q, $rootScope, Facebook, $http) {
          ...
          ServerAuther.prototype.authWithServer = function () {
            ...
            if (!this.authResponse || !this.loggedIn || !this.serverAuthEnabled) {
              ...
              $http.post(this.authUrl, { auth: this.authResponse }).success(function (result) {
          ...
          ServerAuther.prototype.login = function () {
            ...
            if (this.loggedIn) {
              ...
              Facebook.login().then(_.bind(this.handleAuthResponse, this)).then(_.bind(this.authWithServer, this)).then(function (err, result) {
          ...
          ServerAuther.prototype.startSession = function () {
            Facebook.getLoginStatus().then(_.bind(this.handleAuthResponse, this)).then(_.bind(this.authWithServer, this));
          };
